...
\hypersetup{
    ...
    urlcolor=black,
    pdfauthor={\name},
    pdfkeywords={economics, econometrics, industrial organization, applied microeconomics},
...
\begin{minipage}[t]{0.5\textwidth}
  ...
  % \MYhref{https://liberalarts.tulane.edu/departments/economics}{Department of Economics} \\
  % \MYhref{https://murphy.tulane.edu/}{The Murphy Institute} \\
...
\item "The Impact of Hispanic Last Names and Identity on Labor Market Outcomes" \emph{Under Review} [\href{https://hhadah.github.io/hispanic-last-names/my_paper/Hadah-last-names-draft.pdf}{\tt link}]

\item "Peer Effects in Adolescent Mental Health" [\href{https://hhadah.github.io/Depression_Idea/manuscripts/Hadah-Peer-Effect-Depression.pdf}{\tt link}]
...
\item "Sexual Orientation and Racial Discrimination in Mortgage Lending: An Audit Correspondence Field Experiment", with Patrick Button, David Schwegman, Javiera Selman, Tran Nguyen-Phuong, and Cathy Balfe
...
\subsection*{Tulane University, Department of Economics}

\subsection*{As Instructor}

\begin{itemize}

\item Instructor, Urban Economics, Spring 2024 %[\href{https://hussainhadah.com/courses/econ2304/}{Link to course website}]
\end{itemize}
...
%
\item Conferences and workshops attended and planned:
%
\begin{description}

\item[2023:] Stata Texas Empirical Microeconomics Conference; European Society for Population Economics (ESPE); Southern Economic Association Conference, New Orleans ($\times$ 2) %  
...
\begin{minipage}[t]{0.45\textwidth}
  \textbf{Patrick Button}  \\
  Department of Economics \\
  Tulane University \\
  \href{mailto:pbutton@tulane.edu}{\tt pbutton@tulane.edu}
\end{minipage}
\hfill
\begin{minipage}[t]{0.45\textwidth}
  \textbf{Willa Friedman}  \\
  Department of Economics \\
  University of Houston  \\
  \href{mailto:willa.friedman@gmail.com}{\tt willa.friedman@gmail.com}
\end{minipage}

\vspace{1em}  % Adds some space between the two rows of references
